			...
			<div class="card-body">
				<form method="POST" action="{{ route('sub_user.edit_validation') }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input name="user_status" class="user_status" {{old('user_status',$data->user_status)=="Enable" ?"checked" :""}} type="checkbox" value="Enable"><br>
                            Disable
                        <input name="user_status" class="user_status" {{old('user_status',$data->user_status)=="Disable" ?"checked" :""}} type="checkbox" value="Disable"><br>
